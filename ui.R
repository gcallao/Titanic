       ...
       titlePanel("People who did not board the RMS Titanic at Queenstown, what if?"), 
        ...
        sidebarLayout(
                ...
                sidebarPanel(
                        ...
                        h5("In this App we are going to explore through a prediction model based on decision trees, what would happened 
                           if these people had indeed been aboard the ship."),
                        
                        h5("The data used to train the model and to obtain the perfomance indicators belong to the famous competition at 
